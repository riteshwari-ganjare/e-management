                ...
                <tbody>
                  {currentPosts.filter((val)=>{
                    if(searchData===""){
                      ...
                      val.FirstName.toLowerCase().includes(searchData.toLocaleLowerCase())||val.LastName.toLowerCase().includes(searchData.toLocaleLowerCase())||val.City.toLowerCase().includes(searchData.toLocaleLowerCase())||val.Country.toLowerCase().includes(searchData.toLocaleLowerCase())
                  ){
                    return val;
                  }
                  }).map((getdata, index) => (
